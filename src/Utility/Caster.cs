...
namespace XLR8.Utility
{
    ...
    public class Caster
    {
        public static Func<object,T> GetCastConverter<T>()
        {
        ...
        /// <returns></returns>
        public static Func<object, object> GetTypeCaster(Type sourceType, Type targetType)
        {
        ...
        /// <returns></returns>
        public static Func<object,object> GetCastConverter(Type t)
        {
